-- Tables and Store Procedures created to store the information from users, roles and grants information
...
ALTER TASK snapshot_roles SET resume;
ALTER TASK snapshot_grants SET resume;